...
const products: Product[] = [
  {
    category: "Food",
    id: "1",
    image: "https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    inStock: true,
    name: "Premium Food",
...
export default function ProductsPage() {
  ...
  // hardcoding categories as they change rarely
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main className="flex-1 py-10">
        <div
          className={`container-override px-4 md:px-6`}
        >
          {/* Heading & filters */}
          <div
            className={`
          ...
          >
            <div>
              ...
              <p className="mt-1 text-lg text-muted-foreground">
                Browse our latest dishes and find something you&apos;ll love.
              </p>
            </div>

            {/* Category pills */}
            <div className={`${styles.categoryPills} flex flex-wrap gap-2`}>
